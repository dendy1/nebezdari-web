...
urlpatterns = [
    ...
    path('author/<username>/edit/', views.author_edit, name='edit_author'),
    ...
    path('admin/user/<username>/resetpassword/', views.admin_reset_password, name='admin_reset_password'),
    path('admin/user/<username>/delete/', views.admin_user_delete, name='admin_delete_user'),
